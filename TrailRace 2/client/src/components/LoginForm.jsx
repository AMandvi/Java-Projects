...
const LoginForm = () => {
    ...
    // Storing the fields from the form into a user object and passing that, along with
    // login credentials as part of a Post request to Spring Boot.
    ...
    const submitHandler = (e) => {
        ...
        .catch ((error) => {
            console.log("This is our registration submit catch error:", error)
...
const loginUser = (e) => {
    ...
    // This is my reg form. On change of the fields in the, the setFirstName will set "firstName" and so forth through the form
  ...
  return (
    ...
    <div className='row'>
        ...
        <form onSubmit={submitHandler} >
            ...
            {/* This line displays data validations defined in the model and up above in the code */}
