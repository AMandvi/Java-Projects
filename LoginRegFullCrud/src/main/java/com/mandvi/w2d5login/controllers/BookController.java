...
import com.mandvi.w2d5login.services.BookService;
...
// pass in all the libraries
    ...
    public String create(
    		...
    		BindingResult result, RedirectAttributes flash, Model model,HttpSession sesh) {
        if (result.hasErrors()) {
        	List <Library> allLibs = libServ.allLibraries();
    		model.addAttribute("allLibs", allLibs);
            return "create.jsp";
